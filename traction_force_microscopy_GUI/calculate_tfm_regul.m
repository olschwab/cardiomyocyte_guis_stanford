function [ theta,x1,y1,u1,v1,u1_0,v1_0,V,lambda,rho,eta] = calculate_tfm_regul(filename,relax,contr,frame,mask,E,nu,conversion)
...
%regul
[U,s,~]=csvd(Gt);
[lambda,rho,eta,~]=l_curve(U,s,ut(end:-1:1));
lambda=sqrt(lambda);
